...
class cannyEdgeDetector:
    def __init__(self, imgs, height, width, color, sigma=1, kernel_size=5, weak_pixel=75, strong_pixel=255, lowthreshold=0.05,
                 highthreshold=0.15):
        self.imgs = imgs
        self.height = height
        self.width = width
    ...
    def detect(self):
        ...
        for color in range(self.color):
            if(color is 0):
                image = operasiTitik.getR2D(self.imgs, self.height, self.width, self.color)
            elif(color is 1):
                image = operasiTitik.getG2D(self.imgs, self.height, self.width, self.color)
            else:
        ...
        if self.color is 3:
            ...
            result = operasiTitik.combineRGB2DtoRGB(self.imgs_final[0],self.imgs_final[0],self.imgs_final[0],self.height, self.width)
        return result